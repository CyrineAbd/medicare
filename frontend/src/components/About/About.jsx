...
const About = () => {
    ...
    <div className='container'>
        <div className='flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row'>
            ...
            <div className='relative w-3/4 lg:w-1/2 xl:w-[770px] z-10 order-2 lg:order-1'>
                <img src={aboutImg} alt="About Us" className='w-1/2 rounded-[15px]'  />
                    <div className="absolute z-20 bottom-4 w-[200px] md:w-[300px] right-[-7%] lg:right-[22%]">
  ...
  <p className='text_para mt-[30px]'>
    ...
    our patients - not looking back at what we accomplished but towards what we can do tomorrow.
    Providing the best.
  </p>
  <Link to='/'>
